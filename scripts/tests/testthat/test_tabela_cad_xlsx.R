...
test_that("tabela_cad_xlsx converte Cria um resumo das atividades docentes", {
  ...
  expected_path <- system.file("tests/testthat/testdata", "tabela_cad.xlsx", package = "radocr")
  ...
  # Executa a função
  tabela_cad_xlsx(pdf_file1, pdf_file2, output_path)
