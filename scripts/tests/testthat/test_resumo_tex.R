...
test_that("resumo_tex converte Cria um resumo das atividades docentes", {
  ...
  expected_path <- system.file("tests/testthat/testdata", "resumo.tex", package = "radocr")
  ...
  # Executa a função
  resumo_tex(pdf_file1, pdf_file2, output_path)
